...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: yPBAI8SPktIy/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: eeRDt0QNsYAA/css
  ...
  return (
    <BaseDialogTrigger
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__kacwk)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__v6Brr)}
            label={"Open Popover"}
          />
        ),
