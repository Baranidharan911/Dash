...
import sty from "./PlasmicButton.module.css"; // plasmic-import: EOuYsGxeH93F/css
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: l4jkMTSV037Q/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: XbQrY8coJcwe/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__omyDf, {
          [sty.freeBoxcolor_neutral__omyDfRsdEk]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__omyDfzmPeC]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__omyDfd3P1T]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__omyDfh5YrK]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__omyDFwqLb]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__omyDfgva1W]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__omyDf0CjhQ]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__omyDf0CjhQUEgCc]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__duLPn, {
            [sty.freeBoxcolor_neutral__duLPnRsdEk]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__duLPnRsdEkHnXQw]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__duLPnaemak]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__duLPnD3P1T]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__duLPnwqLb]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__duLPnGva1W]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__duLPn0CjhQ]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__uLxAk)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__d8Agb, {
            [sty.freeBoxiconEnd__d8AgbjZ2C]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__d8AgbD3P1T]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__d8AgbwqLb]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__d8AgbGva1W]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__ifmj7)}
                role={"img"}
              />
            ),
