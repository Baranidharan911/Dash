...
import Label from "../../Label"; // plasmic-import: JP_ePra8yUgz/component
import Checkbox from "../../Checkbox"; // plasmic-import: 4AEnMfc6zlZ-/component
import Description from "../../Description"; // plasmic-import: 2JBnyQTx2lhC/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: ir-e5-Mqf-lm/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___3SdA)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__hf3Yv)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__kq27I)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__rPZrp)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
