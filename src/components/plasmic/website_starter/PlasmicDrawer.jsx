...
import Button from "../../Button"; // plasmic-import: EOuYsGxeH93F/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: iZmS0mrjfkHL/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_qhKz6QsnCtkh"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__k9Eth)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
                ...
                {renderPlasmicSlot({
                  defaultContents: (
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__nJaxA)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__npF7N)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__xao0H)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
