...
import SliderThumb from "../../SliderThumb"; // plasmic-import: rCVSqNjSxDTb/component
...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: 6YKRODrqkoTE/css
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox___8Iz2Z)}
        >
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__tfLuc)}>
        <div
