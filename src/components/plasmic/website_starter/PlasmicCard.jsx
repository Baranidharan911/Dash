...
import sty from "./PlasmicCard.module.css"; // plasmic-import: cRQT4x8sYalu/css

createPlasmicElementProxy;

export const PlasmicCard__VariantProps = new Array("noTitle");

export const PlasmicCard__ArgProps = new Array("title", "children");
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {renderPlasmicSlot({
            defaultContents: "Total Prescribers with Total support  >=2000",
            value: args.title,
